...
class BaseController extends Controller
{
    public function __construct()
    {
        ...
        } elseif (request()->routeIs('project.install.finish')) {
    ...
    public function databaseConfigView(Helper $helper)
    {
        ...
        if (ValidationHelper::step() !== 'PASSED') {
            return redirect()->route('project.install.validation.form');
        }
    ...
    public function accountSetup(Helper $helper)
    {
        ...
        if (DBHelper::step('migrate') !== 'PASSED') {
            return redirect()->route('project.install.migration.view');
        }
