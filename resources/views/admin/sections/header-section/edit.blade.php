...
@section('content')
    <div class="custom-card">
        ...
        <div class="card-body">
            <form class="card-form" action="{{ setRoute('admin.setup.header.sections.update', [$slug, $data->id]) }}"
                    ...
                    <div class="dashboard-item-area">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12 mb-15">
                                <a href="{{ setRoute('admin.setup.header.sections.page.index', [$slug, $data->id, slug($data->title->language->$default_lang_code->title)]) }}"
                                    class="d-block">
                                    <div class="dashbord-item border">
                                        <div class="dashboard-content">
                                            ...
                                            <div class="right">
                                                <div class="chart" id="page_content" data-percent="100"><span>100%</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12 mb-15">
                                <a href="{{ setRoute('admin.setup.header.sections.faq.index', [$slug, $data->id, slug($data->title->language->$default_lang_code->title)]) }}"
                                    class="d-block">
                                    <div class="dashbord-item border">
                                        <div class="dashboard-content">
                                            <div class="left">
                                            ...
                                            <div class="right">
                                                <div class="chart" id="faq_content" data-percent="100"><span>100%</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
