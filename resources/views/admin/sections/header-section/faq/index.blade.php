...
@section('content')
    <div class="custom-card">
        <div class="card-header">
            ...
            <div class="table-btn-area">
                @include('admin.components.link.custom', [
                    'href' => route('admin.setup.header.sections.edit', [
                        $type,
                        $parent->id,
                        slug($parent->title->language->$default_lang_code->title),
                    ]),
                    'class' => 'btn btn--base',
                    'text' => __('Back'),
        ...
        <div class="card-body">
            <form class="card-form" action="{{ setRoute('admin.setup.header.sections.faq.update', [$type, $parent->id]) }}"
    ...
    @include('admin.components.modals.header-section.add-faq-item')
        ...
        <div class="modal-data">
            ...
            <div class="modal-form-data">
                <form class="modal-form" method="POST"
                    action="{{ setRoute('admin.setup.header.sections.faq.item.update', [$type, $parent->id]) }}"
...
@push('script')
    <script>
        ...
        $(".delete-modal-button").click(function() {
            var oldData = JSON.parse($(this).parents("tr").attr("data-item"));
            var actionRoute = "{{ setRoute('admin.setup.header.sections.faq.item.delete', [$type, $parent->id]) }}";
