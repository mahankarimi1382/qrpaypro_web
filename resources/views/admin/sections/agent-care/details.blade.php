...
<div class="custom-card mb-20">
    <div class="card-body">
        <div class="row">
            <div class=" col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                <div class="dashbord-item" style="background-color: #f1f1f1;">
                    <div class="dashboard-content">
                        <div class="left">
                            <h6 class="title">{{ __("Total Add Money") }}</h6>
                            <div class="user-info">
                                <h2 class="user-count">{{ get_amount($data['add_money_amount'], get_default_currency_code(),get_wallet_precision()) }}</h2>
                            </div>
                        </div>
                        <div class="right">
            ...
            <div class=" col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                <div class="dashbord-item" style="background-color: #f1f1f1;">
                    <div class="dashboard-content" >
                        <div class="left" style="background-color: #f1f1f1;">
                            <h6 class="title">{{ __("Total Money Out") }}</h6>
                            <div class="user-info">
                                <h2 class="user-count">{{ get_amount($data['money_out_amount'], get_default_currency_code(),get_wallet_precision()) }}</h2>
                            </div>
                        </div>
                        <div class="right">
                            <div class="dashboard-icon">
                ...
                <div class="dashbord-item" style="background-color: #f1f1f1;">
                    <div class="dashboard-content">
                        <div class="left">
                            ...
                            <div class="user-info">
                                <h2 class="user-count">{{ get_amount($data['total_transaction'], get_default_currency_code(),get_wallet_precision()) }}</h2>
                            </div>
                        </div>
                        <div class="right">
                            <div class="dashboard-icon">
...
<div class="custom-card">
    <div class="card-header">
        <h4 class="title">{{ __("Agent Wallets") }}</h4>
    </div>
    <div class="card-body">
        <div class="row align-items-center mb-20">
            @forelse ($data['wallets'] ?? [] as $wallet)
                <div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item" style="background-color: #f1f1f1;">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ $wallet->currency->name }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_amount($wallet->balance, $wallet->currency->code,get_wallet_precision($wallet->currency)) }}</h2>
                                </div>
                            </div>
                            <div class="right">
                                <div class="dashboard-icon">
