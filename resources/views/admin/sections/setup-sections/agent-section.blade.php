                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_bottom_heading',
                                                $data->value->language->$default_lang_code->bottom_heading ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_bottom_sub_heading',
                                                $data->value->language->$default_lang_code->bottom_sub_heading ??
                                                    ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.textarea', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_bottom_details',
                                                $data->value->language->$default_lang_code->bottom_details ?? ''),
                                        ])
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $item->code . '_bottom_heading',
                                                    $data->value->language->$lang_code->bottom_heading ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $item->code . '_bottom_sub_heading',
                                                    $data->value->language->$lang_code->bottom_sub_heading ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.textarea', [
                                                ...
                                                'value' => old(
                                                    $item->code . '_bottom_details',
                                                    $data->value->language->$lang_code->bottom_details ?? ''),
                                            ])
                                        </div>
                                    </div>
                                @endforeach
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#merchant-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
