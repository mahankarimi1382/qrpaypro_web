...
@php
   $pricison = get_precision($payment_gateway);
@endphp
@push('css')
    <style>
        .fileholder {
                                    ...
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="form-group">
                                            @include('admin.components.form.input-amount',[
                                                ...
                                                'name'          => "daily_limit",
                                                'value'         => old("daily_limit",get_amount($payment_gateway->currencies->first()->daily_limit,null,$pricison)),
                                                'currency'      => $payment_gateway->currencies->first()->currency_code,
                                            ])
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6">
                                        <div class="form-group">
                                            @include('admin.components.form.input-amount',[
                                                ...
                                                'name'          => "monthly_limit",
                                                'value'         => old("monthly_limit",get_amount($payment_gateway->currencies->first()->monthly_limit,null,$pricison)),
                                                'currency'      => $payment_gateway->currencies->first()->currency_code,
                                            ])
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form--control" value="{{ old("rate",get_amount($payment_gateway->currencies->first()->rate,null,$pricison)) }}" name="rate" placeholder="Type Here...">
