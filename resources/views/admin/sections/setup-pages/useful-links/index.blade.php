        ...
        <div class="table-wrapper">
            <div class="table-header">
                ...
                <div class="table-btn-area">
                    <a href="#useful-link-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Page') }}</a>
                </div>
            </div>
...
@push('script')
    <script>
        ...
        $(".edit-modal-button").click(function() {
            ...
            editModal.find("input[name=" + default_language + "_title]").val(oldData.title.language[
            ...
            richTextEditorReinit(document.querySelector("#useful-link-edit textarea[name=" + default_language +
                "_details]"));

            $.each(languages, function(index, item) {
                editModal.find("input[name=" + item.code + "_title]").val(oldData.title.language[item.code]
                    .title);
                editModal.find("textarea[name=" + item.code + "_details]").val(oldData.details.language[item
                    .code].details);

                richTextEditorReinit(document.querySelector("#useful-link-edit textarea[name=" + item.code +
                    "_details]"));
            });
