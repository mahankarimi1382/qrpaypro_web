    ...
    <div class="row mt-20 mb-20-none">
        <div class="col-xl-7 col-lg-7 mb-20">
            <div class="custom-card mt-10">
                ...
                <div class="card-body">
                    <form class="card-form" action="{{ setRoute('merchant.money.exchange.submit') }}" method="POST">
                        @csrf
                        <div class="row">
                        ...
                        @if($basic_settings->merchant_pin_verification == true)
                            <div class="col-xl-12 col-lg-12">
                                <a href="javascript:void(0)" class="btn--base w-100 btn-loading exchange" data-bs-toggle="modal" data-bs-target="#checkPin">{{ __("Exchange Money") }} <i class="fas fas fa-exchange-alt ms-1"></i></a>
                            </div>
                            @include('merchant.components.modal.pin-check')
                        @else
                            <div class="col-xl-12 col-lg-12">
                                <button type="submit" class="btn--base btn-loading w-100 exchange">{{ __("Exchange Money") }} <i class="fas fas fa-exchange-alt ms-1"></i></button>
                            </div>
                        @endif
                    </form>
                </div>
        ...
        <div class="col-xl-5 col-lg-5 mb-20">
            ...
            {{-- limit section  --}}
            <div class="dash-payment-item-wrapper mt-10">
                <div class="dash-payment-item active">
                    <div class="dash-payment-title-area">
                        <span class="dash-payment-badge">!</span>
        ...
        <div class="dashboard-header-wrapper">
            ...
            <div class="dashboard-btn-wrapper">
                <div class="dashboard-btn mb-2">
                    <a href="{{ setRoute('merchant.transactions.index','money-exchange') }}" class="btn--base">{{__("View More")}}</a>
                </div>
            </div>
        </div>
...
@push('script')
    <script>
        ...
        function previewDetails(){
            ...
            //converted amount
            var convertedAmount = exchangeFromAmount*exchangeRate.toFixed(acceptVar().exchangeToDigit);
