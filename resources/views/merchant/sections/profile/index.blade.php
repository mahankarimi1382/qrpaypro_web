                    ...
                    <div class="dashboard-header-wrapper">
                        ...
                        <div class="profile-action-btn">
                            <a href="javascript:void(0)"
                                class="btn--base btn btn-sm delete-btn">{{ __('delete Account') }}</a>
                            @if ($basic_settings->merchant_pin_verification == true)
                                <a href="{{ setRoute('merchant.setup.pin.index') }}"
                                    class="btn--base btn">{{ __('Setup PIN') }}</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body profile-body-wrapper">
                        <form class="card-form" method="POST" action="{{ setRoute('merchant.profile.update') }} "
                            ...
                            <div class="profile-settings-wrapper">
                                <div class="preview-thumb profile-wallpaper">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview merchant bg_img"
                                            data-background="{{ get_image('frontend/') }}/images/element/virtual-card.png">
                                        </div>
                                    </div>
                                </div>
                                <div class="profile-thumb-content">
                                    ...
                                    <div class="profile-content">
                                        ...
                                        <ul class="user-info-list mt-md-2">
                                            <li><i
                                                    class=" {{ $user->registered_by == global_const()::PHONE ? 'las la-phone' : 'las la-envelope' }}"></i>{{ __('Registered By') }}
                                                : {{ $user->registered_by ?? '' }}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form--control"
                                                ...
                                                {{ $user->registered_by == global_const()::PHONE ? 'readonly' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        ...
                                        <input type="email" name="email" class="form--control"
                                            ...
                                            {{ $user->registered_by == global_const()::EMAIL ? 'readonly' : '' }}>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 form-group">
                                        @include('admin.components.form.input', [
                                            'label' => __('address'),
...
@push('script')
    <script>
        ...
        $(".delete-btn").click(function() {
            ...
            var message =
                `${deleteSureText} <strong> ${btnText}</strong>?<br>${firstText} “<strong>${projectName}</strong>”  ${fullText}, click “${btnText}”.?`;
