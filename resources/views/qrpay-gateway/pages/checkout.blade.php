        ...
        <div class="container">
            <div class="form-wrapper h- d-flex flex-column justify-content-center vh-100">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <form class="demo-payment-form" method="POST"
                            action="{{ route('merchant.checkout.initiate.payment') }}">
                            @csrf
                            <div class="title-area mb-20">
                                <h3>{{ __('QRPAY Merchant Website') }}</h3>
                            </div>
                            <div class="form-group">
                                <label for="amount" class="form-label">{{ __('Pay Amount') }} <span
                            ...
                            <div class="badge-area mt-20 text-center">
                                <span class="form-text powered-badge"> <a
                                        href="{{ 'https://qrpay.appdevs.net/' }}">{{ __('Powered by QRPay') }}</a></span>
                            </div>
                        </form>
                    </div>
                </div>
