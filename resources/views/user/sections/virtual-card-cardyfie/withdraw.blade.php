                    ...
                    <div class="dash-payment-item-wrapper">
                        <div class="dash-payment-item active">
                            ...
                            <div class="dash-payment-body">
                                <form class="card-form" action="{{ setRoute('user.cardyfie.virtual.card.withdraw') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 form-group">
                                            <label>{{ __("Withdrawal Amount") }} <span class="text--base">*</span></label>
                                            <div class="input-group">
                                                <input type="text" class="form--control number-input" required placeholder="{{__('enter Amount')}}" name="withdraw_amount" value="{{ old("withdraw_amount") }}" autocomplete="off">
                                        ...
                                        <div class="col-xl-12 col-lg-12 form-group">
                                            <label>{{ __("appL To Wallet") }} <span class="text--base">*</span></label>
                                        ...
                                        @if($basic_settings->user_pin_verification == true)
                                                <div class="col-xl-12 col-lg-12">
                                                    <a href="javascript:void(0)" class="btn--base w-100 btn-loading withdrawBtn" data-bs-toggle="modal" data-bs-target="#checkPin">{{ __("Withdraw Card") }} <i class="las la-plus-circle ms-1"></i></a>
                                                </div>
                                            </div>
                                            @include('user.components.modal.pin-check')
                                        @else
                                                <div class="col-xl-12 col-lg-12">
                                                    <button type="submit" class="btn--base w-100 withdrawBtn btn-loading">{{__("Withdraw Card")}} <i class="las la-plus-circle ms-1"></i></button>
                                                </div>
                                            </div>
                                        @endif
                                </form>
                                        ...
                                        <div class="preview-list-left">
                                            <div class="preview-list-user-wrapper">
                                                ...
                                                <div class="preview-list-user-content">
                                                    <span>{{ __("Withdrawal Amount") }}</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="dash-payment-item active">
                            ...
                            <div class="dash-payment-body">
                                <div class="preview-list-wrapper">
                                    ...
                                    @endif
                                    @if ($cardCharges->monthly_limit > 0)
                                        <div class="preview-list-item">
                                            <div class="preview-list-left">
                                                <div class="preview-list-user-wrapper">
                                                    <div class="preview-list-user-icon">
...
<script>
    ...
    function acceptVar() {
        ...
        var currencyMinAmount     = "{{getAmount($cardCharges->min_limit)}}";
        var currencyMaxAmount     = "{{getAmount($cardCharges->max_limit)}}";
        var currencyFixedCharge   = "{{getAmount($cardCharges->card_withdraw_fixed_fee)}}";
        var currencyPercentCharge = "{{getAmount($cardCharges->card_withdraw_percent_fee)}}";
        var currencyDailyLimit    = "{{getAmount($cardCharges->daily_limit)}}";
        var currencyMonthlyLimit  = "{{getAmount($cardCharges->monthly_limit)}}";
    ...
    function getPreview() {
        ...
        senderAmount = (senderAmount === "" || isNaN(senderAmount)) ? 0 : Number(senderAmount);
        ...
        $('.payable-total').html(pay_in_total.toFixed(acceptVar().sPrecison) + " " + from_currency);

    }
    function enterLimit(){
        var currencyRate = acceptVar().currencyRate;
        var min_limit = parseFloat("{{getAmount($cardCharges->min_limit)}}") * parseFloat(currencyRate);
        var max_limit =parseFloat("{{getAmount($cardCharges->max_limit)}}") * parseFloat(currencyRate);
