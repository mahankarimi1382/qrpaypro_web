                        ...
                        <form class="card-form" action="{{ setRoute('user.make.payment.confirmed') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-12 col-xl-12 col-lg-12 form-group paste-wrapper">
                                    <label>{{ __("Phone/Email") }} ({{ __("Merchant") }})<span class="text--base">*</span></label>
    ...
    var defualCurrencyRate = "{{ get_default_currency_rate() }}";
       ...
       function getLimit(){
           ...
           if($.isNumeric(min_limit) && $.isNumeric(max_limit)) {
               ...
               $('.limit-show').html(min_limit_calc.toFixed(acceptVar().sPrecison) + " " + sender_currency + " - " + max_limit_clac.toFixed(acceptVar().sPrecison) + " " + sender_currency);
               return {
       ...
       function getFees(){
           ...
           $(".fees-show").html( parseFloat(charges.fixed).toFixed(acceptVar().sPrecison) + " " + sender_currency + " + " + parseFloat(percent).toFixed(acceptVar().sPrecison) + "%  = " + parseFloat(charges.total).toFixed(acceptVar().sPrecison));
       }
       function getPreview(){
           var sender_currency = acceptVar().sCurrencyCode;
           var sender_currency_rate = acceptVar().sCurrencyRate;
