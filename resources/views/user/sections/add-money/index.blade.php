...
<script>
    ...
    function feesCalculation() {
        ...
        if ($.isNumeric(percent_charge) && $.isNumeric(fixed_charge) && $.isNumeric(sender_amount)) {
            ...
            var percent_charge_calc = (parseFloat(sender_amount) / 100) * parseFloat(percent_charge) * parseFloat(exchange_rate);
    ...
    function getFees() {
        ...
        $(".fees-show").html("{{ __('charge') }}: " + parseFloat(charges.fixed).toFixed(presion) + " " + gCurrencyCode + " + " + parseFloat(charges.percent).toFixed(presion) + "%");
    }
