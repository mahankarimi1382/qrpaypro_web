        ...
        <div class="dashboard-list-item-wrapper">
            <div class="dashboard-list-item sent">
                    ...
                    <div class="dashboard-list-user-wrapper">
                        ...
                        <div class="dashboard-list-user-content">
                            ...
                            @elseif ($item->type == payment_gateway_const()::TYPEMAKEPAYMENT)
                                    @if ($item->attribute == payment_gateway_const()::SEND)
                                        <h4 class="title">{{ __("Make Payment to") }} ({{$item->details->receiver->email??$item->details->receiver_email }}) </h4>
                                    @elseif ($item->attribute == payment_gateway_const()::RECEIVED)
                                        <h4 class="title">{{ __("Make Payment From") }} ({{$item->details->sender->email??$item->details->sender_username}}) </h4>
                                    @endif
                            @elseif ($item->type == payment_gateway_const()::SENDREMITTANCE)
                                    @if ($item->attribute == payment_gateway_const()::SEND)
                                        <h4 class="title">{{ __("Send Remittance to") }} {{ __(" (".@$item->details->receiver->email.")") }} </h4>
                                    @elseif ($item->attribute == payment_gateway_const()::RECEIVED)
                                        <h4 class="title">{{ __("Received Remittance from") }} {{ __(" (".@$item->details->sender->email.")") }} </h4>
                                    @endif
                            ...
                            @elseif ($item->type == payment_gateway_const()::TYPEPAYLINK)
                                @if($item->attribute == payment_gateway_const()::RECEIVED)
                                    <h4 class="title">{{ __('Add Balance via') }} <span class="text--warning">({{ __("Payment Link") }})</span></h4>
                                @else
                            ...
                            @elseif ($item->type == payment_gateway_const()::MARKETPLACE)
                                ...
                                <span class="{{ $item->stringMarketplaceStatus->class }}">{{ __($item->stringMarketplaceStatus->value) }} </span>

                            @elseif ($item->type == payment_gateway_const()::TRADE)

                                <h4 class="title">{{ @$item->trx_id }} ({{ __('Trade') }})</h4>

                                <span class="{{ $item->TradeStringStatus->class }}">{{ __($item->TradeStringStatus->value) }} </span>


                            @endif


                            @if ($item->type != payment_gateway_const()::MARKETPLACE)
                            @if ($item->type != payment_gateway_const()::TRADE)
                ...
                <div class="dashboard-list-right">
                    ...
                    @elseif($item->type == payment_gateway_const()::VIRTUALCARD)
                        <h4 class="main-money text--warning">{{ get_amount($item->request_amount,$item->details->charges->card_currency??get_default_currency_code()) }}</h4>
                        <h6 class="exchange-money fw-bold">{{ get_amount($item->payable,$item->details->charges->from_currency??get_default_currency_code(),get_wallet_precision($item->creator_wallet->currency)) }}</h6>
                    @elseif ($item->type == payment_gateway_const()::TYPEMONEYEXCHANGE)
                    ...
                    @elseif ($item->type == payment_gateway_const()::MERCHANTPAYMENT)
                        @if ($item->attribute == payment_gateway_const()::SEND)
                        <h6 class="exchange-money text--warning ">{{ get_amount($item->request_amount,$item->details->charges->sender_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h6>
                        <h4 class="main-money fw-bold">{{ get_amount($item->details->charges->payable,$item->details->charges->payable_currency??get_default_currency_code(),get_wallet_precision($item->creator_wallet->currency)) }}</h4>
                        @endif
                    @elseif ($item->type == payment_gateway_const()::REQUESTMONEY)
                        @if ($item->attribute == payment_gateway_const()::SEND)
                            <h6 class="exchange-money text--warning ">{{ get_amount($item->details->charges->request_amount,$item->details->charges->sender_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h6>
                            <h4 class="main-money text--base"> {{ get_amount($item->details->charges->request_amount,$item->details->charges->sender_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h4>
                        @elseif ($item->attribute == payment_gateway_const()::RECEIVED)
                            <h6 class="exchange-money fw-bold">{{ get_amount($item->details->charges->receiver_amount,$item->details->charges->receiver_currency) }}</h6>
                    ...
                    @elseif ($item->type == payment_gateway_const()::TYPEPAYLINK)
                        ...
                        @else
                            <h4 class="main-money text--base">{{ get_amount($item->request_amount, @$item->details->charge_calculation->receiver_currency_code) }}</h4>
                    ...
                    @elseif ($item->type == payment_gateway_const()::AGENTMONEYOUT)
                        @if ($item->attribute == payment_gateway_const()::SEND)
                        <h6 class="exchange-money text--warning ">{{ get_amount($item->details->charges->sender_amount,$item->details->charges->sender_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h6>
                        <h4 class="main-money fw-bold">{{ get_amount($item->details->charges->payable,$item->details->charges->sender_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h4>
                        @endif
                    @elseif ($item->type == payment_gateway_const()::MONEYIN)
                        @if ($item->attribute == payment_gateway_const()::RECEIVED)
                        <h6 class="exchange-money text--warning ">{{ get_amount($item->request_amount,$item->details->charges->receiver_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h6>
                        <h4 class="main-money fw-bold">{{ get_amount($item->payable,$item->details->charges->receiver_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h4>
                        @endif
                    @elseif($item->type == payment_gateway_const()::GIFTCARD)
                        <h4 class="main-money text--warning">{{ get_amount($item->request_amount,$item->details->card_info->user_wallet_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h4>
                        <h6 class="exchange-money fw-bold">{{ get_amount($item->payable,$item->details->card_info->user_wallet_currency,get_wallet_precision($item->creator_wallet->currency)) }}</h6>
                    @elseif ($item->type == payment_gateway_const()::TYPEREFERBONUS)
                        <h4 class="exchange-money fw-bold text--base">{{ get_amount($item->request_amount,$item->details->request_currency) }}</h4>
                    @elseif ($item->type == payment_gateway_const()::TYPEBONUS)
                        <h4 class="exchange-money fw-bold text--base">{{ get_amount($item->request_amount,$item->details->request_currency) }}</h4>
                    @elseif ($item->type == payment_gateway_const()::MARKETPLACE)
                        @if (auth()->user()->id == $item->user_id && $item->attribute == payment_gateway_const()::SEND)
                            <h4 class="main-money text--warning">{{ get_amount(@$item->payable,$item->trade->rateCurrency->code,get_wallet_precision($item->trade->rateCurrency)) }}</h4>
                            <h6>{{ get_amount(@$item->payable+$item->charge->total_charge,$item->trade->rateCurrency->code,get_wallet_precision($item->trade->rateCurrency)) }}</h6>
                        @else
                            {{-- <h4>{{ @$item->trade->amount }}</h4> --}}
                            <h4 class="main-money text--warning">{{ get_amount(@$item->trade->amount,$item->trade->saleCurrency->code,get_wallet_precision($item->trade->saleCurrency)) }}</h4>
                            <h6>{{ get_amount(@$item->payable,$item->trade->rateCurrency->code,get_wallet_precision($item->trade->rateCurrency)) }}</h6>
                        @endif

                    @elseif ($item->type == payment_gateway_const()::TRADE)
                        <h4 class="main-money text--warning">{{ get_amount(@$item->payable,$item->trade->saleCurrency->code,get_wallet_precision($item->trade->saleCurrency)) }}</h4>
                        <h4>{{ get_amount(@$item->trade->amount+$item->charge->total_charge,$item->trade->saleCurrency->code,get_wallet_precision($item->trade->saleCurrency)) }}</h4>
            ...
            <div class="preview-list-wrapper">
                ...
                <div class="preview-list-item">
                    <div class="preview-list-left">
                        <div class="preview-list-user-wrapper">
                            ...
                            <div class="preview-list-user-content">
                                <span>{{ __("Asking Amount") }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="preview-list-right">
                        <span>{{ get_amount(@$item->trade->rate,$item->trade->rateCurrency->code,get_wallet_precision($item->trade->rateCurrency)) }}</span>
                    </div>
                </div>
                @endif
                @if ($item->type == payment_gateway_const()::MARKETPLACE)
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            <span>{{ @$item->trade->user->firstname. ' ' .@$item->trade->user->lastname }}</span>
                        </div>
                    </div>
                ...
                <div class="preview-list-item">
                    ...
                    <div class="preview-list-right">
                        ...
                        @elseif ($item->type == payment_gateway_const()::SENDREMITTANCE)
                            <span>1 {{ $item->details->charges->sender_amount??get_default_currency_code() }} = {{ get_amount($item->details->charges->exchange_rate??$item->details->to_country->rate,$item->details->to_country->code,get_wallet_precision($item->creator_wallet->currency)) }}</span>
                        @elseif ($item->type == payment_gateway_const()::TYPEMONEYOUT)
                        ...
                        @elseif ($item->type == payment_gateway_const()::TYPEADDSUBTRACTBALANCE)
                            <span>1 {{ get_default_currency_code() }} = {{ get_amount($item->user_wallet->currency->rate,$item->user_wallet->currency->code,get_wallet_precision($item->creator_wallet->currency)) }}</span>
                        @elseif ($item->type == payment_gateway_const()::TYPEPAYLINK)
                            @if($item->attribute == payment_gateway_const()::RECEIVED)
                            ...
                            @else
                            <span>1 {{ @$item->details->charge_calculation->receiver_currency_code }} = {{ get_amount($item->details->charge_calculation->exchange_rate??$item->details->charge_calculation->s_exchange_rate, @$item->details->charge_calculation->sender_cur_code) }}</span>
                            @endif
                        @elseif ($item->type == payment_gateway_const()::BILLPAY)
                        ...
                        @elseif ($item->type == payment_gateway_const()::TYPEBONUS)
                            <span>{{ get_amount(1,$item->details->request_currency) ." = ". get_amount($item->details->exchange_rate,$item->details->payment_currency)}}</span>
                        @elseif ($item->type == payment_gateway_const()::MARKETPLACE)
                            <span> 1 {{ @$item->trade->saleCurrency->code }} = {{ get_amount((@$item->trade->rate / @$item->trade->amount), $item->trade->rateCurrency->code , get_wallet_precision($item->trade->rateCurrency)) }}</span>
                        @elseif ($item->type == payment_gateway_const()::TRADE)
                            <span>1 {{ $item->trade->saleCurrency->code }} = {{ get_amount(($item->trade->rate / $item->trade->amount), $item->trade->rateCurrency->code,get_wallet_precision($item->trade->rateCurrency)) }}</span>
                ...
                @else
                    ...
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            ...
                            @elseif ($item->type == payment_gateway_const()::TYPEPAYLINK)
                                ...
                                @else
                                <span class="text--danger">{{ get_amount(0,$item->details->charge_calculation->sender_cur_code,get_wallet_precision($item->creator_wallet->currency)) }}</span>
                                @endif
                            @elseif ($item->type == payment_gateway_const()::GIFTCARD)
                    ...
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            ...
                            @elseif ($item->type == payment_gateway_const()::TYPEMONEYOUT)
                                <span> {{ isCrypto($item->details->charges->will_get ?? $item->payable,withdrawCurrency($item)['gateway_currency'],$item->currency->gateway->crypto) }}</span>
                            @elseif ($item->type == payment_gateway_const()::BILLPAY)
                            ...
                            @elseif ($item->type == payment_gateway_const()::VIRTUALCARD)
                                ...
                                <span class="fw-bold"> {{ get_amount(@$item->details->card_info->amount??@$item->details->card_info->balance,$item->details->charges->card_currency??get_default_currency_code()) }}</span>
                ...
                @if ($item->type == payment_gateway_const()::VIRTUALCARD)
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            <span class="fw-bold">{{ get_amount($item->available_balance,$item->details->charges->from_currency??get_default_currency_code(),get_wallet_precision($item->creator_wallet->currency)) }}</span>
                        </div>
                    </div>
                @endif
                @if ($item->type == payment_gateway_const()::TYPEMONEYEXCHANGE)
                    ...
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            <span class="fw-bold text-success">{{ get_amount($item->available_balance,$item->creator_wallet->currency->code,get_wallet_precision($item->creator_wallet->currency)) }}</span>
                        </div>
                    </div>
                @endif
                @if ($item->type == payment_gateway_const()::SENDREMITTANCE)
                ...
                @if ($item->type == payment_gateway_const()::REQUESTMONEY)
                    @if ($item->attribute == payment_gateway_const()::SEND)
                        <div class="preview-list-item">
                            ...
                            <div class="preview-list-right">
                                <span class="text--warning">{{ get_amount($item->request_amount,$item->creator_wallet->currency->code,get_wallet_precision($item->creator_wallet->currency)) }}</span>
                            </div>
                        </div>
                        <div class="preview-list-item">
                            <div class="preview-list-left">
                ...
                @endif
                    ...
                    @if ($item->type == payment_gateway_const()::TYPEPAYLINK)
                        @if($item->attribute == payment_gateway_const()::RECEIVED)
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="text--success">{{ get_amount($item->available_balance, $item->details->charge_calculation->receiver_currency_code,get_wallet_precision($item->creator_wallet->currency)) }}</span>
                                </div>
                            </div>
                 ...
                 @if ($item->type == payment_gateway_const()::AGENTMONEYOUT)
                    ...
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            <span class="text--base">{{ get_amount($item->available_balance,$item->details->charges->sender_currency,get_wallet_precision($item->creator_wallet->currency)) }}</span>
                        </div>
                    </div>
                    <div class="preview-list-item">
                        <div class="preview-list-left">
            ...
            @if ($item->type == payment_gateway_const()::GIFTCARD)
                ...
                <div class="preview-list-item">
                    ...
                    <div class="preview-list-right">
                        <span class="text--success">{{ get_amount($item->available_balance,$item->details->card_info->user_wallet_currency,get_wallet_precision($item->creator_wallet->currency)) }}</span>
                    </div>
                </div>
            @endif
            ...
            <div class="preview-list-item">
                ...
                <div class="preview-list-right">
                    <span class="text--base">{{ get_amount($item->available_balance,$item->details->request_currency) }}</span>
                </div>
            </div>
        @endif
        @if ($item->type == payment_gateway_const()::TYPEBONUS)
