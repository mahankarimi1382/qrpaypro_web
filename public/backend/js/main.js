...
var storedHtmlMarkup = {
  ...
  <div class="card-body">
    <div class="row align-items-center">
        ...
        <div class="col-xxl-2 col-xl-4 col-lg-4 mb-10">
          ...
          <div class="col-xxl-2 col-xl-4 col-lg-4 mb-10">
            <div class="custom-inner-card">
                <div class="card-inner-header d-block">
                    <h5 class="title">Transaction Limit</h5>
                    <span class="small text--base">(Execute if the value is greater than zero)</span>
                </div>
                <div class="card-inner-body">
                    <div class="row">
                        <div class="col-xl-12 form-group">
                           <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form--control daily-limit" value="0" name="" step="any">
                                    <span class="input-group-text currency"></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 form-group">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form--control monthly-limit" value="0" name="" step="any">
                                    <span class="input-group-text currency"></span>
                                </div>
                            </div>
                        </div>
