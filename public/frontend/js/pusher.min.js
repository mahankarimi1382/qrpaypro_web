                    ...
                    return (
                        (t.prototype.send = function (t, e) {
                            this.timeline.isEmpty() ||
                                this.timeline.send(
                                    Se.TimelineTransport.getAgent(this, t),
                                    e
                                );
                        }),
                        t
                    ...
                    return (
                        ...
                        (t.prototype.connect = function () {
                            if (
                                ...
                                this.timelineSenderTimer = new M(
                                    6e4,
                                    function () {
                                        e.send(t);
                                    }
