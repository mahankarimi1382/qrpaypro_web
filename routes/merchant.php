...
Route::prefix("merchant")->name("merchant.")->group(function(){
    ...
    Route::middleware('module:merchant-receive-money')->group(function(){
     ...
     //Money Exchange
    Route::middleware(['module:merchant-money-exchange','merchant.pin.setup.guard'])->group(function(){
        //money exchange
        Route::controller(MoneyExchangeController::class)->prefix("money-exchange")->name("money.exchange.")->group(function(){
            Route::get('/','index')->name("index");
            Route::post('submit','moneyExchangeSubmit')->name('submit')->middleware('kyc.verification.guard');
        });
    });
    //Pay Link
