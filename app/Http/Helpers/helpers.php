...
function userWalletOnBaseCurrency($wallets)
{
    $totalAmount = 0;
    foreach ($wallets as $wallets) {
        // $requestAmount = $wallets->profit_amount;
        // $result = $requestAmount / $wallets->userWallet->currency->rate;
        // $result = $requestAmount / $exchange_rate;
...
function totalInvestOnBaseCurrency($invests)
{
    ...
    foreach ($invests as $invest) {
        $requestAmount = $invest->invest_amount;
        $result = $requestAmount / $invest->wallet->currency->rate;
        // $result = $requestAmount / $exchange_rate;
        $totalAmount += $result;
    }
    return $totalAmount ?? 0;
