...
use App\Http\Resources\User\TradeLogs;
...
use App\Http\Resources\User\MarketplaceLogs;
...
class TransactionController extends Controller
{
    ...
    public function index($slug = null) {
        ...
        $trade              = Transaction::auth()->trade()->orderByDesc("id")->get();
        $marketplace        = Transaction::auth()->marketplace()->orderByDesc("id")->get();
        ...
        $transactions = [
            ...
            'trade'             => TradeLogs::collection($trade),
            'marketplace'       => MarketplaceLogs::collection($marketplace),
        ];
        ...
        $transaction_types = [
            ...
            'trade'             => PaymentGatewayConst::TRADE,
